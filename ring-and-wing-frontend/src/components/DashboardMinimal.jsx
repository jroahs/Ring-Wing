  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const statsResponse = await fetch(`${API_URL}/api/revenue/daily`, {
          signal: controller.signal
        });
        ...
        const monthlyStatsResponse = await fetch(`${API_URL}/api/revenue/monthly`, {
          signal: controller.signal
        });
        ...
        const monthlyHistoricalResponse = await fetch(`${API_URL}/api/revenue/historical/monthly`, {
          signal: controller.signal
        });
